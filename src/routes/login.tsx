...
import { ArrowRight, Eye, EyeOff, ShieldCheck, TrendingUp } from "lucide-react";

export const Route = createFileRoute("/login")({
  head: () => ({
    meta: [
      { title: "Вход — Ledgr" },
      { name: "description", content: "Войдите в свой аккаунт Ledgr, чтобы управлять финансами." },
    ],
  }),
  component: LoginPage,
});
    ...
    <div className="min-h-screen grid lg:grid-cols-2 bg-bg font-sans text-ink antialiased">
      ...
      <div className="flex items-center justify-center px-6 py-12">
        <div className="w-full max-w-sm">
          ...
          <h1 className="font-display text-3xl font-extrabold tracking-tight">С возвращением</h1>
          <p className="text-ink-muted text-sm mt-2 mb-8">
            Войдите, чтобы продолжить отслеживать свои финансы.
          </p>
    ...
    <div className="hidden lg:flex relative flex-col justify-between overflow-hidden bg-ink p-12 text-white">
      ...
      <div className="relative max-w-sm">
        <h2 className="font-display text-4xl font-extrabold leading-tight tracking-tight">
          Деньги под <span className="text-brand">контролем</span>, а не в хаосе.
        </h2>
        <p className="text-white/60 mt-4 leading-relaxed">
          Минималистичный трекер личных финансов. Записывай приход и расход за секунды.
        </p>

        <div className="mt-10 space-y-3">
          <Highlight icon={<TrendingUp className="size-4" />} text="Наглядная динамика баланса" />
          <Highlight icon={<ShieldCheck className="size-4" />} text="Privacy-first и open-source" />
        </div>
      </div>
